            ...
            <div class="w-full max-w-md relative z-10">
                ...
                <div class="glass-card rounded-3xl shadow-2xl p-8 lg:p-10 border border-slate-200/50 animate-slideIn" style="animation-delay: 0.2s">
                    <div class="mb-8">
                        ...
                        <h2 class="text-4xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent mb-2">Daftar Akun Baru ✨</h2>
                        <p class="text-slate-500">Lengkapi formulir untuk memulai</p>
                    </div>

                    <!-- Error Messages -->
                    @if($errors->any())
                        <div class="mb-6 p-4 bg-rose-50 border-l-4 border-rose-500 rounded-r-xl animate-fadeIn">
                            <div class="flex items-start text-rose-700">
                                <i class="fas fa-exclamation-circle text-xl mr-3 mt-0.5"></i>
                                <div class="flex-1">
                                    <span class="font-semibold block mb-2">Terdapat kesalahan:</span>
                    ...
                    <form action="{{ route('register.post') }}" method="POST" class="space-y-5">
                        ...
                        <div class="relative group" x-data="{ focused: false, show: false }">
                            ...
                            <label 
                                ...
                                class="absolute left-4 top-2 text-xs font-bold text-slate-500 transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-4 peer-focus:top-2 peer-focus:text-xs peer-focus:text-[#B1B2FF]"
                            >
                                <i class="fas fa-lock mr-1"></i> Password (min. 8 karakter)
                            </label>
                            <button 
                                type="button"
                                @click="show = !show"
                    ...
                    <div class="mt-8 text-center">
                        <div class="relative inline-block">
                            <p class="text-slate-600">
                                Sudah punya akun? 
                                <a href="{{ route('login') }}" class="font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#B1B2FF] to-[#9091EB] hover:from-[#9091EB] hover:to-[#7071C9] transition-all relative group">
                                    Masuk di sini
